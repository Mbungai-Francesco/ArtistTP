...
export const CreateRating = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(201).json({ message: 'Rating created', data: createRating });
  } catch (error: any) {
...
export const UpdateRating = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(200).json({ message: 'Rating updated', data: updateRating });
  } catch (error: any) {
    console.log(error.message);
    return res.status(500).json({ message: 'Internal Server Error' });
  }
...
export const DeleteRating = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(200).json({ message: 'Rating deleted', data: deleteRating });
  } catch (error: any) {
    console.log(error.message);
    return res.status(500).json({ message: 'Internal Server Error' });
  }
